...
// Source: github.com/Ali-Gorgani/simplebank/db/sqlc (interfaces: Store)
...
// CheckVerifyEmail mocks base method.
func (m *MockStore) CheckVerifyEmail(arg0 context.Context, arg1 db.CheckVerifyEmailParams) (db.VerifyEmail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckVerifyEmail", arg0, arg1)
	ret0, _ := ret[0].(db.VerifyEmail)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CheckVerifyEmail indicates an expected call of CheckVerifyEmail.
func (mr *MockStoreMockRecorder) CheckVerifyEmail(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckVerifyEmail", reflect.TypeOf((*MockStore)(nil).CheckVerifyEmail), arg0, arg1)
}
